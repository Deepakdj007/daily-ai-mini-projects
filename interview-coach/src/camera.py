...
ready to stream. The coach uses this to observe body language.
"""
...
class Camera:
    ...
    def read_jpeg_frame(self) -> bytes | None:
        ...
        OpenCV delivers frames in BGR; Pillow expects RGB, so channels are
        flipped before encoding. thumbnail() preserves aspect ratio while
        capping the longest side at 768 px.
        """
