...
def normalize(text: str) -> str:
    """Fold typography and whitespace so patterns match what models actually emit."""
...
if __name__ == "__main__":
    ...
    print("OK - boundary matching, separators, typography, hedges and stale assertions")
